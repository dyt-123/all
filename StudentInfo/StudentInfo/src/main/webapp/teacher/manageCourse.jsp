            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                        ...
                        <c:if test="${page_Num != pageInfo.pageNum }">
                            <li>
                                <a href="/StudentInfo/TeacherHandler/managecou/${sessionScope.tid }/${page_Num }">${page_Num }</a>
                            </li>
                        </c:if>
                    ...
                    <li><a href="/StudentInfo/TeacherHandler/managecou/${sessionScope.tid }/${pageInfo.pages}">末页</a>
                    </li>
                </ul>
            </nav>
        </div>
