        ...
        <div class="col-md-12">
            ...
            <form action="../TeacherHandler/moditypassword/${sessionScope.tid }" method="get">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3"><input type="password" name="tpassword" class="form-control"
                                                 onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');"
                                                 maxlength="16"/></div>
                    <div class="col-md-3"><input class="btn btn-primary btn-wide login-btn" type="submit" value="确定修改"/>
                    </div>
